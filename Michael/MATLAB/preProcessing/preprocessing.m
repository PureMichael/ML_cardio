...
i1train = find(num(1:len_train,23)==1);
i2train = find(num(1:len_train,23)==2);
i3train = find(num(1:len_train,23)==3);

i1test = find(num(len_train+1:x,23)==1);
i2test = find(num(len_train+1:x,23)==2);
i3test = find(num(len_train+1:x,23)==3);
